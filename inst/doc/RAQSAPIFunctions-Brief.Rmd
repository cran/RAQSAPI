...
**These fourteen services are**:
 ...
 - **Monitors** (monitors_by_*) 
 - **Sample Data** (sampledata_by_*)
 - **Daily Summary Data** (dailydata_by_*) 
 - **Annual Summary Data** (annualdata_by_*)
 - **Quarterly Summary Data** (q
 - **Quality Assurance - Blanks Data** (qa_blanks_by_*) 
 ...
 - **Quality Assurance - One Point Quality Control Raw Data**
    (qa_one_point_qc_by_*)
 - **Quality Assurance - PEP Audits** (qa_pep_audit_by_*)
 ...
 - **Quality Assurance - Annual Performance Evaluations** \
     (aqs_qa_annualpeferomanceeval_by_*)
